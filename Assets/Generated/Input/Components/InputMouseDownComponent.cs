...
public partial class InputEntity {
    ...
    public void AddMouseDown(UnityEngine.Vector2 newWorldPosition, UnityEngine.Vector2 newScreenPosition) {
    ...
    public void ReplaceMouseDown(UnityEngine.Vector2 newWorldPosition, UnityEngine.Vector2 newScreenPosition) {
        var index = InputComponentsLookup.MouseDown;
        var component = (MouseDownComponent)CreateComponent(index, typeof(MouseDownComponent));
        component.worldPosition = newWorldPosition;
        component.screenPosition = newScreenPosition;
